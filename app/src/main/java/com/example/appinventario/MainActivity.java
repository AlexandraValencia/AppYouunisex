...
public class MainActivity extends AppCompatActivity {
    ...
    private void guardarDatosFirebase(){
        try {
            ...
            if( miToken!="" ||  miToken!=null) {
                usuarios user = new usuarios(nombre, "valenciaquiroz.01@gmail.com", urlCompletaImg, urlCompletaImgFirestore, miToken);
                if (id != null) {
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if (photoFile != null) {
                        try {
                            Uri photoURI = FileProvider.getUriForFile(MainActivity.this, "com.example.appinventario.fileprovider", photoFile);
